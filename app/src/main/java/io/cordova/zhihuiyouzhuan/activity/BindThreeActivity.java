...
import static io.cordova.zhihuiyouzhuan.UrlRes.casAuthenticationWeChat2ControllerUrl;
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        if (wxBindBean.isSuccess() ) {
                            ...
                            try {
                                ...
                                Intent intent0 = new Intent(BindThreeActivity.this,Main2Activity.class);

...
import io.cordova.zhihuiyouzhuan.fingerprint.LoginPageOperationListener;
...
import io.cordova.zhihuiyouzhuan.utils.fingerUtil.FingerprintUtil;
import io.cordova.zhihuiyouzhuan.widget.XCRoundImageView;
import io.cordova.zhihuiyouzhuan.widget.finger.CommonTipDialog;
import io.cordova.zhihuiyouzhuan.widget.finger.FingerprintVerifyDialog;
import io.cordova.zhihuiyouzhuan.widget.finger.PromptButton;
import io.cordova.zhihuiyouzhuan.widget.finger.PromptButtonListener;
import io.cordova.zhihuiyouzhuan.widget.finger.PromptDialog;

import static io.cordova.zhihuiyouzhuan.activity.SplashActivity.PASSWORD_LOGIN_FLAG;
...
public class LoginActivity3 extends BaseActivity implements View.OnClickListener, FingerprintHelper.SimpleAuthenticationCallback {
    ...
    protected void initView() {
       ...
       /* fingerprintLoginFragment = new FingerprintLoginFragment();
        ...
        if (SPUtil.getInstance().getBoolean(MyConstants.SP_HAD_OPEN_FINGERPRINT_LOGIN)) {

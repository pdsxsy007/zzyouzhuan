...
import io.cordova.zhihuiyouzhuan.bean.WXInfoBean;
...
import io.cordova.zhihuiyouzhuan.bean.FaceBean;
import io.cordova.zhihuiyouzhuan.bean.LogInTypeBean;
...
import io.cordova.zhihuiyouzhuan.widget.InputMethodLayout;
import pub.devrel.easypermissions.AfterPermissionGranted;
import pub.devrel.easypermissions.EasyPermissions;

import static io.cordova.zhihuiyouzhuan.UrlRes.casWeChatApiLoginControllerUrl;
            ...
            switch (position){
                ...
                case 2:
                    ...
                    ll_item.setOnClickListener(new View.OnClickListener() {
                        ...
                        /*    String result = "{\n" +
                                    "\t\"country\": \"中国\",\n" +
                                    "\t\"unionid\": \"oBjK91dvrZ3znU7D00tjPr53GZeo\",\n" +
                                    "\t\"gender\": \"男\",\n" +
                                    "\t\"city\": \"郑州\",\n" +
                                    "\t\"openid\": \"o8b-A00WEb3GhNx-iVYRitWSglmA\",\n" +
                                    "\t\"language\": \"zh_CN\",\n" +
                                    "\t\"profile_image_url\": \"http://thirdwx.qlogo.cn/mmopen/vi_32/1azd1GXZKJaXdjMia2k9p1nEK2nWPgdxRpPtNL4icibFAcOWXJ6ic5epfuS9TVKicic40m3JRes2PPTe60N2Ye7gyF4g/132\",\n" +
                                    "\t\"accessToken\": \"24_mnFN4AAyCErH6zIVIK-tPAAn5z9iefsqijb3gZuEo8vlsAtSAquGi9__C_a5oOJGzXUSomik9U6vjaJcTwv26DJuyf1y8UQf9f7NJuYTySc\",\n" +
                                    "\t\"access_token\": \"24_mnFN4AAyCErH6zIVIK-tPAAn5z9iefsqijb3gZuEo8vlsAtSAquGi9__C_a5oOJGzXUSomik9U6vjaJcTwv26DJuyf1y8UQf9f7NJuYTySc\",\n" +
                                    "\t\"uid\": \"oBjK91dvrZ3znU7D00tjPr53GZeo\",\n" +
                                    "\t\"province\": \"河南\",\n" +
                                    "\t\"screen_name\": \"xing\",\n" +
                                    "\t\"name\": \"xing\",\n" +
                                    "\t\"iconurl\": \"http://thirdwx.qlogo.cn/mmopen/vi_32/1azd1GXZKJaXdjMia2k9p1nEK2nWPgdxRpPtNL4icibFAcOWXJ6ic5epfuS9TVKicic40m3JRes2PPTe60N2Ye7gyF4g/132\",\n" +
                                    "\t\"expiration\": \"1566362097882\",\n" +
                                    "\t\"expires_in\": \"1566362097882\",\n" +
                                    "\t\"refreshToken\": \"24_QEooEMosCY05m9EhbDrLDtF_DNrMfxDQtuj_bWLidNYfNshXWT50QrJgs1469aMGDVpbX6wTCEHjn6V7wS1t5VmlWGeHBjKlqGcI71R1_YM\"\n" +
                                    "}";
                            WXInfoBean wxInfoBean = JsonUtil.parseJson(result,WXInfoBean.class);
                            String name = wxInfoBean.getName();
                            String gender = wxInfoBean.getGender();

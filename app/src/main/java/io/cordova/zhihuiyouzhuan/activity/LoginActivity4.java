...
import io.cordova.zhihuiyouzhuan.bean.GetUserIdBean;
...
import io.cordova.zhihuiyouzhuan.utils.SystemBarTintUtils;
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        if (loginBean.isSuccess() ) {
                            ...
                            try {
                                ...
                                Intent intent2 = new Intent(MyApp.getInstance(),Main2Activity.class);

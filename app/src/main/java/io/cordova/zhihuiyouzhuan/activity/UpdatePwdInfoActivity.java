        ...
        rl_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    String pwdOld = URLEncoder.encode(AesEncryptUtile.encrypt(oldP, AesEncryptUtile.key), "UTF-8");
                    String pwdNew = URLEncoder.encode(AesEncryptUtile.encrypt(newConfirmP, AesEncryptUtile.key), "UTF-8");
                    String type0 = URLEncoder.encode(AesEncryptUtile.encrypt(type, AesEncryptUtile.key), "UTF-8");
                    OkGo.<String>get(UrlRes.HOME2_URL + UrlRes.updatePasswordUrl)

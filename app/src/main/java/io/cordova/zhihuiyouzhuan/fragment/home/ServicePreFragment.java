        ...
        OkGo.<String>post(UrlRes.HOME_URL + UrlRes.Service_APP_List)
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        if (serviceAppListBean.isSuccess()){
                           obj1.clear();
                            obj1 .addAll(serviceAppListBean1.getObj()) ;
...
//            Log.i("url2", "== " + url);
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            if (url.contains( "http://61.163.104.243:18082/cas/login")) {
                if (StringUtils.isEmpty((String)SPUtils.get(MyApp.getInstance(),"username",""))){
                    Intent intent = new Intent(getActivity(),LoginActivity2.class);
                    startActivity(intent);
                    return true;
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            CookieUtils.syncCookie("http://61.163.104.243:18082","CASTGC="+SPUtils.get(getActivity(),"TGC",""),getActivity());

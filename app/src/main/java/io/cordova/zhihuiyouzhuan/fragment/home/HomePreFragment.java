...
//                .setAgentWebParent((LinearLayout) view, -1, new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT))//传入AgentWeb的父控件。
                .useDefaultIndicator(getResources().getColor(R.color.colorPrimary),3)//设置进度条颜色与高度，-1为默认值，高度为2，单位为dp。
                ...
                .go("http://yd.hntyxxh.com:18083/portal/portal-yyzy/portal-app/app/index.html");
    ...
    private WebViewClient mWebViewClient = new WebViewClient() {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
            ...
            if (!url.equals("http://yd.hntyxxh.com:18083/_t9/main.htm")){
